...
class Encoder(nn.Module):
    ...
    def __init__(self):
        ...
        self.inplanes = 32
        self.layer1 = self._make_layer(32, 3, [2, 2])  # [50, 200]
        self.layer2 = self._make_layer(64, 4, [2, 2])  # [25, 100]
        self.layer3 = self._make_layer(128, 6, [2, 1])  # [13, 100]
        self.layer4 = self._make_layer(256, 6, [2, 1])  # [7, 100]
        self.layer5 = self._make_layer(512, 3, [2, 1])  # [4, 100]
        self.layer6 = self._make_layer(512, 3, [2, 2])  # [2, 50]
        self.layer7 = self._make_layer(512, 3, [2, 2])  # [1, 25]
    ...
    def forward(self, x):
        ...
        cnn_feat = x7.squeeze(2)  # [batch_size, channel, width]
